  ...
  return (
    <footer className=" border-t dark:border-neutral-700" aria-labelledby="footer-heading">
      ...
      <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <img src="/logo.png" className='w-12 mb-12' alt="" />
        <div className="pb-8 xl:grid xl:grid-cols-5 xl:gap-8">
          <div className="grid grid-cols-2 gap-8 xl:col-span-4">
            <div className="md:grid md:grid-cols-2 md:gap-8">
              <div>
                <h3 className="text-sm text-gray-400 font-semibold  tracking-wider uppercase">Solutions</h3>
                <ul role="list" className="mt-4 space-y-4">
                  {navigation.solutions.map((item) => (
                    <li key={item.name}>
                      <a href={item.href} className="text-base dark:text-gray-200 ">
                        {item.name}
                      </a>
                    </li>
                  ))}
        ...
        <div className="border-t border-gray-200 pt-8 lg:flex lg:items-center lg:justify-between xl:mt-0">
          <div>
            ...
            <p className="mt-2 text-base dark:text-gray-200">
          ...
          <form className="mt-4 sm:flex sm:max-w-md lg:mt-0">
            ...
            <div className="mt-3 rounded-md sm:mt-0 sm:ml-3 sm:flex-shrink-0">
              <button
                type="submit"
                className="w-full bg-[#FE5754] border border-transparent rounded-md py-2 px-4 flex items-center justify-center text-base font-medium text-white focus:outline-none focus:ring-0 "
              >
                Subscribe
              </button>
            </div>
        ...
        <div className="mt-8 border-t border-gray-200 pt-8 md:flex md:items-center md:justify-between">
          <div className="flex space-x-6 md:order-2">
            {navigation.social.map((item) => (
              <a key={item.name} href={item.href} className="text-gray-400 hover:dark:text-gray-200">
          ...
          <p className="mt-8 text-xs text-gray-400 md:mt-0 md:order-1">
            &copy; 2022 CSD for Big Beat Electronics, LLC. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
